...
import com.chareem.customCamera.sujaul.facetracker.OverlayView;
import com.chareem.customCamera.sujaul.ui.model.Media;
import com.chareem.customCamera.sujaul.utils.DateTimeUtils;
...
public class CameraControlPanel extends RelativeLayout
    ...
    private CameraSoundView cameraSoundView;
    ...
    private CameraSoundView.OnSoundTypeChangeListener onSoundTypeChangeListener;
    ...
    private TrackerOnDrawListener trackerOnDrawListener;
    ...
    private void init() {
        ...
        cameraSoundView = findViewById(R.id.sound_camera_switcher);
        ...
        tvLocation = findViewById(R.id.location_tv);
        ...
        setOnSoundTypeChangeListener(onSoundTypeChangeListener);
        ...
        trackingOverlay.addCallback(
                new OverlayView.DrawCallback() {
                    ...
                    public void drawCallback(final Canvas canvas) {
                        if (trackerOnDrawListener != null){
                            trackerOnDrawListener.onTracker(canvas);
                        }
                    }
                });
    }
    ...
    private void toggleControls(boolean isVisible) {
        ...
        cameraSoundView.setEnabled(isVisible);
    }
    ...
    public void rotateControls(int rotation) {
        ...
        cameraSoundView.setRotation(rotation);
    ...
    public void setOnSoundTypeChangeListener(CameraSoundView.OnSoundTypeChangeListener onSoundTypeChangeListener) {
        this.onSoundTypeChangeListener = onSoundTypeChangeListener;
        if (cameraSoundView != null)
            cameraSoundView.setOnSoundTypeChangeListener(this.onSoundTypeChangeListener);
    }
    ...
    public void setOnTrackerOnDrawListener(TrackerOnDrawListener trackerOnDrawListener) {
        this.trackerOnDrawListener = trackerOnDrawListener;
    }
    ...
    public interface TrackerOnDrawListener {
        void onTracker(Canvas canvas);
    }
    ...
    public void showSetting(boolean isShown) {
        settingsButton.setVisibility(isShown ? VISIBLE : GONE);
    }
    ...
    public void showLocation(boolean isShown){
        tvLocation.setVisibility(isShown ? VISIBLE : GONE);
    }

    public void showSoundSetting(boolean isShown){
        cameraSoundView.setVisibility(isShown ? VISIBLE : GONE);
    }
    ...
    public void setCameraSoundView(int type){
        recordButton.setSoundOn(type == CameraSoundView.SOUND_TYPE_ON);
    }

    public void setCameraFacingView(int type){
        cameraSwitchView.setCameraType(type);
    }

    public void setDevaultSoundType(int type){
        cameraSoundView.setSoundType(type);
    }
