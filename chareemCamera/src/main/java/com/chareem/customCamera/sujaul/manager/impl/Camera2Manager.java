package com.chareem.customCamera.sujaul.manager.impl;
...
import com.chareem.customCamera.sujaul.utils.ImageSaver;
...
public final class Camera2Manager extends BaseCameraManager<String, TextureView.SurfaceTextureListener>
    ...
    private boolean isPauseOrDestroyed = false;
    ...
    private Camera2Manager(CameraPhotoListener cameraPhotoListener, boolean isUseFaceDetection) {
        this.cameraPhotoListener = cameraPhotoListener;
        this.isUseFaceDetection = isUseFaceDetection;
    }

    public static Camera2Manager getInstance(CameraPhotoListener cameraPhotoListener, boolean isUseFaceDetection) {
        currentInstance = new Camera2Manager(cameraPhotoListener, isUseFaceDetection);
