...
public class Camera1Manager extends BaseCameraManager<Integer, SurfaceHolder.Callback>
    ...
    private Camera1Manager(CameraPhotoListener cameraPhotoListener, Activity activity, boolean isUseFaceDetection) {
        this.cameraPhotoListener = cameraPhotoListener;
        this.activity = activity;
        this.isUseFaceDetection = isUseFaceDetection;
    }

    public static Camera1Manager getInstance(CameraPhotoListener cameraPhotoListener, Activity activity, boolean isUseFaceDetection) {
        currentInstance = new Camera1Manager(cameraPhotoListener, activity, isUseFaceDetection);
