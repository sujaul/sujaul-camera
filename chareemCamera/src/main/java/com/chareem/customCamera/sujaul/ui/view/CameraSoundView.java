...
public class CameraSoundView extends AppCompatImageButton {
    ...
    private void initializeView() {
        volumeOnDrawable = ContextCompat.getDrawable(context, R.drawable.ic_volume_up_24);
        volumeOnDrawable = DrawableCompat.wrap(volumeOnDrawable);

        volumeOffDrawable = ContextCompat.getDrawable(context, R.drawable.ic_volume_off_24);
